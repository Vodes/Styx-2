...
fun styxDarkColors() = darkColors(primary = Color(0, 180, 85),
...
fun styxLightColors() = lightColors(primary = Color(0, 180, 85),
    primaryVariant = Color(0, 160, 58),
    secondary = Color(168, 85, 247),
    secondaryVariant = Color(162, 28, 175),
...
val styxTypography = Typography(defaultFontFamily= FontFamily(Font("fonts/OpenSans-Regular.ttf", FontWeight.Normal, FontStyle.Normal),
